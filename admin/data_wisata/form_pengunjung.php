                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Form Kunjungan</h6>
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="./data_pengunjung.php?id_wisata=<?php echo $_GET['id_wisata'] ?>">Data Kunjungan</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <?php if (empty($_GET['id_kunjungan'])) { ?>
                                    <div class="col-6 text-right">
                                        <a href="../dashboards/dashboard.php" class="btn btn-sm btn-neutral btn-round btn-icon" data-toggle="tooltip" data-original-title="Edit product">
                        ...
                        <div class="card-body">
                            <form action="<?php if (isset($_GET['id_kunjungan'])) {
                                ...
                                <?php if (isset($_GET['id_kunjungan'])) { ?>
                                    ...
                                    <a href="./data_pengunjung.php?id_wisata=<?php echo $_GET['id_wisata'] ?>" onclick="return confirm('Apakah anda akan keluar?');">
