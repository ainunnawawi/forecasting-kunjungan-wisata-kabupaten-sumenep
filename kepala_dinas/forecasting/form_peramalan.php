        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Peramalan</h6>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-8">
                    <p class="mb-0">
                      Peramalan akan dilakukan dengan metode Hold-winter Aditif dan Multiplikatif dengan musim yang telah ditentukan sepanjang 12 periode (bulan):
                      <br/>
                    </p>
                  </div>
                </div>
                ...
                <form action="hasil_peramalan.php" method="get" class="needs-validation" novalidate>
                  <div class="form-group">
                      <label class="form-control-label" for="validationCustom01">Pilih Wisata</label>
                  ...
                  <button class="btn btn-primary" type="submit">Ramalkan</button>
                </form>
              </div>
            </div>
          </div>
