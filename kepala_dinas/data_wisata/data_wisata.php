  ...
  <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  d-flex  align-items-center">
        <a class="navbar-brand" href="../../kepala_dinas/data_wisata/data_wisata.php">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="../../kepala_dinas/data_wisata/data_wisata.php">
                <i class="ni ni-chart-bar-32 text-primary"></i>
                <span class="nav-link-text">Data Wisata</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../kepala_dinas/forecasting/form_peramalan.php">
                ...
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">
                      <?php
                      $query = mysqli_query($koneksi, "SELECT id_user, nama_user FROM tabel_user WHERE email='$_SESSION[email]'");
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="./data_wisata.php"><i class="fas fa-home"></i></a></li>
                      ...
                      <div class="col ml--2">
                        <h5 class="mb-0">
                          <a href="../data_wisata/data_pengunjung.php?id_wisata=<?php echo $wisata['id_wisata'] ?>">
                            <span class="nav-link-text"><?php echo $wisata['nama_wisata'] ?></span>
